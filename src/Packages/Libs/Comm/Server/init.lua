...
function Server.BindFunction(
	...
	local folder = Util.GetCommSubFolder(parent, "Owl_RF"):Expect("Failed to get Comm RF folder")
...
function Server.CreateSignal(
	...
	local folder = Util.GetCommSubFolder(parent, "Owl_RE"):Expect("Failed to get Comm RE folder")
...
function Server.CreateProperty(
	...
	local folder = Util.GetCommSubFolder(parent, "Owl_RP"):Expect("Failed to get Comm RP folder")
